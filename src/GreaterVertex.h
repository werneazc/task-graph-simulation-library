//! \file GreaterVertex.h
//! \brief Task graph representation of a comparison operation

#ifndef GREATERVERTEX_H_
#define GREATERVERTEX_H_
...
namespace vc_utils
{
    ...
    class GreaterVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit GreaterVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &GreaterVertex::execute, this ),
                ( this->getName( ) + "_GreaterVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~GreaterVertex( ) = default;

    private:
        // forbidden constructors:
        GreaterVertex( ) = delete; //!< \brief because vertexID should be unique
        GreaterVertex( const GreaterVertex& _source ) =
            delete; //!< \brief because sc_module could not be copied
        GreaterVertex( GreaterVertex&& _source ) =
            delete; //!< \brief because move not implemented for sc_module
        GreaterVertex& operator=( const GreaterVertex& _source ) = delete; //!< \brief forbidden
        GreaterVertex& operator=( GreaterVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "GreaterVertex"; }
