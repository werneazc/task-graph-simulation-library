...
#ifndef LOWERVERTEX_H_
#define LOWERVERTEX_H_
...
namespace vc_utils
{
    ...
    class LowerVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit LowerVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &LowerVertex::execute, this ),
                ( this->getName( ) + "_LowerVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~LowerVertex( ) = default;

    private:
        // forbidden constructors:
        LowerVertex( ) = delete; //!< \brief because vertexID should be unique
        LowerVertex(
            const LowerVertex& _source ) = delete; //!< \brief because sc_module could not be copied
        LowerVertex(
            LowerVertex&& _source ) = delete; //!< \brief because move not implemented for sc_module
        LowerVertex& operator=( const LowerVertex& _source ) = delete; //!< \brief forbidden
        LowerVertex& operator=( LowerVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "LowerVertex"; }
