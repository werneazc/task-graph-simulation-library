...
#ifndef RSHIFTVERTEX_H_
#define RSHIFTVERTEX_H_
...
namespace vc_utils
{
    ...
    class RShiftVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit RShiftVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &RShiftVertex::execute, this ),
                ( this->getName( ) + "_RShiftVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~RShiftVertex( ) = default;

    private:
        // forbidden constructors:
        RShiftVertex( ) = delete; //!< \brief because vertexID should be unique
        RShiftVertex( const RShiftVertex& _source ) =
            delete; //!< \brief because sc_module could not be copied
        RShiftVertex( RShiftVertex&& _source ) =
            delete; //!< \brief because move not implemented for sc_module
        RShiftVertex& operator=( const RShiftVertex& _source ) = delete; //!< \brief forbidden
        RShiftVertex& operator=( RShiftVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "RShiftVertex"; }
