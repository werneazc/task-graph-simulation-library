//! \file NotEqualVertex.h
//! \brief short description

#ifndef NOTEQUALVERTEX_H_
#define NOTEQUALVERTEX_H_
...
namespace vc_utils
{
    ...
    class NotEqualVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit NotEqualVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &NotEqualVertex::execute, this ),
                ( this->getName( ) + "_NotEqualVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~NotEqualVertex( ) = default;

    private:
        // forbidden constructors:
        NotEqualVertex( ) = delete; //!< \brief because vertexID should be unique
        NotEqualVertex( const NotEqualVertex& _source ) =
            delete; //!< \brief because sc_module could not be copied
        NotEqualVertex( NotEqualVertex&& _source ) =
            delete; //!< \brief because move not implemented for sc_module
        NotEqualVertex& operator=( const NotEqualVertex& _source ) = delete; //!< \brief forbidden
        NotEqualVertex& operator=( NotEqualVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "NotEqualVertex"; }
