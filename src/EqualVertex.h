...
#ifndef EQUALVERTEX_H_
#define EQUALVERTEX_H_
...
namespace vc_utils
{
    ...
    class EqualVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit EqualVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &EqualVertex::execute, this ),
                ( this->getName( ) + "_EqualVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~EqualVertex( ) = default;

    private:
        // forbidden constructors:
        EqualVertex( ) = delete; //!< \brief because vertexID should be unique
        EqualVertex(
            const EqualVertex& _source ) = delete; //!< \brief because sc_module could not be copied
        EqualVertex(
            EqualVertex&& _source ) = delete; //!< \brief because move not implemented for sc_module
        EqualVertex& operator=( const EqualVertex& _source ) = delete; //!< \brief forbidden
        EqualVertex& operator=( EqualVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "EqualVertex"; }
