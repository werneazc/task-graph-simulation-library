...
#ifndef LEQUALVERTEX_H_
#define LEQUALVERTEX_H_
...
namespace vc_utils
{
    ...
    class LEqualVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit LEqualVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &LEqualVertex::execute, this ),
                ( this->getName( ) + "_LEqualVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~LEqualVertex( ) = default;

    private:
        // forbidden constructors:
        LEqualVertex( ) = delete; //!< \brief because vertexID should be unique
        LEqualVertex( const LEqualVertex& _source ) =
            delete; //!< \brief because sc_module could not be copied
        LEqualVertex( LEqualVertex&& _source ) =
            delete; //!< \brief because move not implemented for sc_module
        LEqualVertex& operator=( const LEqualVertex& _source ) = delete; //!< \brief forbidden
        LEqualVertex& operator=( LEqualVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "LEqualVertex"; }
