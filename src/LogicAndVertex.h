//! \file LogicAndVertex.h
//! \brief short description

#ifndef LOGICANDVERTEX_H_
#define LOGICANDVERTEX_H_
...
namespace vc_utils
{
    ...
    class LogicAndVertex : public sc_core::sc_module, public Task_Base
    {
    public:
        //! \brief constructor with sc_time object
        explicit LogicAndVertex( ProcessUnit_Base* _pUnit, name_t _name, unsigned int _vertexNumber,
              ...
              m_ProcessUnit( _pUnit )
        {
            ...
            sc_core::sc_spawn( sc_bind( &LogicAndVertex::execute, this ),
                ( this->getName( ) + "_LogicAndVertexProcess" ).c_str( ) );
        ...
        //! \brief destructor
        virtual ~LogicAndVertex( ) = default;

    private:
        // forbidden constructors:
        LogicAndVertex( ) = delete; //!< \brief because vertexID should be unique
        LogicAndVertex( const LogicAndVertex& _source ) =
            delete; //!< \brief because sc_module could not be copied
        LogicAndVertex( LogicAndVertex&& _source ) =
            delete; //!< \brief because move not implemented for sc_module
        LogicAndVertex& operator=( const LogicAndVertex& _source ) = delete; //!< \brief forbidden
        LogicAndVertex& operator=( LogicAndVertex&& _source ) = delete;      //!< \brief forbidden
    ...
    public:
        ...
        virtual const char* kind( ) const override { return "LogicAndVertex"; }
